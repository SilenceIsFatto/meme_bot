...
def format_embed(interaction=None, author=None, title=None, description=None, type="rich", colour=9807270, thumbnail="", footer="Cat Memes"):
...
def guild_reddit_embed(subreddit_name=None, interaction=None, random_meme=None, meme_link=None):
    subreddit_name_r = f"r/{subreddit_name} | {random_meme[0]}"
